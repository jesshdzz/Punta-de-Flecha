        ...
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 dark:from-gray-900 dark:to-green-900/30">
            <div className="container p-6 mx-auto">
                <div className="mb-6">
                    ...
                    <h1 className="mb-2 text-3xl font-bold text-gray-900 dark:text-base-content">Registrar Asistencia</h1>
                    <p className="text-gray-600 dark:text-base-content/70">Registrar porcentaje de asistencia de un estudiante</p>
                </div>

                <Card className="max-w-2xl mx-auto bg-white shadow-lg dark:bg-gray-800">
                    <CardHeader>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className={`w-full rounded-md border ${errores.estudianteId ? "border-red-500" : "border-gray-300 dark:border-gray-600"
                            ...
                            <div className="space-y-2">
                                ...
                                <select
                                    ...
                                    className={`w-full rounded-md border ${errores.materiaId ? "border-red-500" : "border-gray-300 dark:border-gray-600"
                                        } bg-white dark:bg-gray-700 py-2 px-3 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:text-white`}
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:text-white"
                                />
                            </div>
                            ...
                            <div className="flex gap-4 pt-4">
                                ...
                                <Button type="submit" disabled={guardando} className="flex-1 text-white bg-blue-600 hover:bg-blue-700 dark:text-white">
                                    {guardando ? (
                                        "Guardando..."
                                    ) : (
                                        <>
